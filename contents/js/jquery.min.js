...
$(function () {
    ...
    function feedCleaner() {
        var feedsCount = $killfeedbox.children().length;
        if (feedsCount > 0) {
            DisposeFeed($killfeedbox.children().first());
        }
    }
